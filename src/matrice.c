...
/*   Updated: 2017/05/23 08:43:00 by rmenegau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	matrice(double *x, double *y, double *z, t_env *e)
{
	...
	*x = tmpx * cos(e->scene.rotation.roty)
		+ tmpz * sin(e->scene.rotation.roty);
	*y = tmpy;
	*z = tmpx * -sin(e->scene.rotation.roty) + tmpz
		* cos(e->scene.rotation.roty);
