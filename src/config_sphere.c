...
/*   Updated: 2017/06/19 16:02:45 by lomeress         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		config2sp(t_ray ray, double *t, double tmp, t_sphere sphere, int s)
{
	...
	if (s == 3)
	{
		if ((i.x > sphere.f1.x || i.x < sphere.f2.x) || (i.y > sphere.f1.y || i.y < sphere.f2.y))
		{
			i = get_point(ray, tmp);
			if ((i.x > sphere.f1.x || i.x < sphere.f2.x) || (i.y > sphere.f1.y || i.y < sphere.f2.y))
				return (0);
...
int		config3sp(t_ray ray, double *t, double tmp, t_sphere sphere, int s)
{
	...
	if (s == 5)
	{
		if ((i.x > sphere.f1.x || i.x < sphere.f2.x) || (i.z > sphere.f1.z || i.z < sphere.f2.z))
		{
			i = get_point(ray, tmp);
			if ((i.x > sphere.f1.x || i.x < sphere.f2.x) || (i.z > sphere.f1.z || i.z < sphere.f2.z))
				return (0);
	...
	if (s == 6)
	{
		if ((i.y > sphere.f1.y || i.y < sphere.f2.y) || (i.z > sphere.f1.z || i.z < sphere.f2.z))
		{
			i = get_point(ray, tmp);
			if ((i.y > sphere.f1.y || i.y < sphere.f2.y) || (i.z > sphere.f1.z || i.z < sphere.f2.z))
				return (0);
...
int		config4sp(t_ray ray, double *t, double tmp, t_sphere sphere, int s)
{
	...
	if (s == 7)
	{
		if ((i.x > sphere.f1.x || i.x < sphere.f2.x) || (i.y > sphere.f1.y || i.y < sphere.f2.y) || (i.z > sphere.f1.z || i.z < sphere.f2.z))
		{
			i = get_point(ray, tmp);
			if ((i.x > sphere.f1.x || i.x < sphere.f2.x) || (i.y > sphere.f1.y || i.y < sphere.f2.y) || (i.z > sphere.f1.z || i.z < sphere.f2.z))
				return (0);
