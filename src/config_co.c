...
int		config2co(t_ray ray, double *t, double tmp, t_cone co, int s)
{
	...
	if (s == 3)
	{
		if ((i.x > co.f1.x || i.x < co.f2.x) || (i.y > co.f1.y || i.y < co.f2.y))
		{
			i = get_point(ray, tmp);
			if ((i.x > co.f1.x || i.x < co.f2.x) || (i.y > co.f1.y || i.y < co.f2.y))
				return (0);
...
int		config3co(t_ray ray, double *t, double tmp, t_cone co, int s)
{
	...
	if (s == 5)
	{
		if ((i.x > co.f1.x || i.x < co.f2.x) || (i.z > co.f1.z || i.z < co.f2.z))
		{
			i = get_point(ray, tmp);
			if ((i.x > co.f1.x || i.x < co.f2.x) || (i.z > co.f1.z || i.z < co.f2.z))
				return (0);
	...
	if (s == 6)
	{
		if ((i.y > co.f1.y || i.y < co.f2.y) || (i.z > co.f1.z || i.z < co.f2.z))
		{
			i = get_point(ray, tmp);
			if ((i.y > co.f1.y || i.y < co.f2.y) || (i.z > co.f1.z || i.z < co.f2.z))
				return (0);
...
int		config4co(t_ray ray, double *t, double tmp, t_cone co, int s)
{
	...
	if (s == 7)
	{
		if ((i.x > co.f1.x || i.x < co.f2.x) || (i.y > co.f1.y || i.y < co.f2.y) || (i.z > co.f1.z || i.z < co.f2.z))
		{
			i = get_point(ray, tmp);
			if ((i.x > co.f1.x || i.x < co.f2.x) || (i.y > co.f1.y || i.y < co.f2.y) || (i.z > co.f1.z || i.z < co.f2.z))
				return (0);
