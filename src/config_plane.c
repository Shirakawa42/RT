...
int		config2pl(t_ray ray, double *t, t_plane plane, int s)
{
	...
	if (s == 3)
	{
		if ((i.x > plane.f1.x || i.x < plane.f2.x) || (i.y > plane.f1.y || i.y < plane.f2.y))
				return (0);
	}
	if (s == 4)
	{
...
int		config3pl(t_ray ray, double *t, t_plane plane, int s)
{
	...
	if (s == 5)
	{
		if ((i.x > plane.f1.x || i.x < plane.f2.x) || (i.z > plane.f1.z || i.z < plane.f2.z))
				return (0);
	}
	if (s == 6)
	{
		if ((i.y > plane.f1.y || i.y < plane.f2.y) || (i.z > plane.f1.z || i.z < plane.f2.z))
				return (0);
	}
	return(1);
}
...
int		config4pl(t_ray ray, double *t, t_plane plane, int s)
{
	...
	if (s == 7)
	{
		if ((i.x > plane.f1.x || i.x < plane.f2.x) || (i.y > plane.f1.y || i.y < plane.f2.y) || (i.z > plane.f1.z || i.z < plane.f2.z))
				return (0);
	}
	return(1);
}
