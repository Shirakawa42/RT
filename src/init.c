...
//	e.scene.objects[0] = create_plane(vec(0, 2, 0), create_color(1.0, 1.0, 1.0), 0, WOOD, vec(0, 0, 0), vec(0, 0, 0), vec(0, 0, 0), 3);
//	e.scene.objects[1] = create_plane(vec(0, -2, 0), create_color(1.0, 1.0, 1.0), 0, GRASS, vec(0, 0, 0), vec(0, 0, 0), vec(0, 0, 0), 3);
...
//	e.scene.objects[0] = create_plane(vec(4, 0, 0), create_color(1.0, 1.0, 1.0), 0.5, 0, vec(0, 0, M_PI/2), vec(0, 0, 0), vec(0, 0, 0), 3);
//	e.scene.objects[3] = create_plane(vec(-4, 0, 0), create_color(1.0, 1.0, 1.0), 0, LAVA, vec(0, 0, M_PI/2), vec(0, 0, 0), vec(0, 0, 0), 3);
//	e.scene.objects[0] = create_plane(vec(-4, 0, 10), create_color(1.0, 1.0, 1.0), 1, LAVA, vec(M_PI/2, 0, 0), vec(0, 0, 0), vec(0, 0, 0), 3);

	e.scene.objects[1].type = 0;
